...
if (!isset($_SESSION['email'])) {
    header("location: https://localhost/tradeam/admin/login.php");
}else{
?>
...
<?php
    ...
    //get all ads
    // $sel_all_ads = "SELECT * FROM `ads_images` AS img INNER JOIN `ads` AS p on img.ad_id = p.ad_id WHERE poster_id = '$id' GROUP BY p.ad_id";
    $sel_all_ads = "SELECT * FROM  ads order by ad_id desc";
        ...
        <div class="main-content">
            ...
            <main>
                ...
                if ($count_rows < 1) {
                    echo "<center>
                    <h2 class = 'mt-5'>
                    Your have Not Uploaded Any Ad Yet<br> 
                    <span class ='pt-5'>
