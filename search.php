...
if (!isset($_GET["search"])) {
    ...
    $q = $_GET['keyword'];
     //get all ads
     $sel_all_ads = "SELECT * FROM `ads` WHERE ad_name LIKE '%$q%' GROUP BY ad_id DESC limit 20";
...
<body>
    ...
    <section class="container latest-products">
        ...
        <center><button id="show" class = "my-5">Show More</button></center>
    </section>
  </main>
