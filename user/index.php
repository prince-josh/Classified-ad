                ...
                <div class="row">
                    <div class="col-sm-6 col-lg-4 col-xl-3 mb-3">
                        <div class="card">
                              ...
                              <div class="more-info"> <a href="my-ads.php">More Info</a></div>
                          </div>     
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 mb-3">
                        <div class="card">
                              ...
                              <div class="more-info"> <a href="active-ads.php">More Info</a></div>
                          </div>     
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 mb-3">
                        <div class="card">
                              ...
                              <div class="more-info"> <a href="pending-ads.php">More Info</a></div>
                          </div>     
                    </div>
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3 mb-3">
                        <div class="card">
                              ...
                              <div class="more-info"> <a href="myads.php">More Info</a></div>
                          </div>     
                    </div>
                </div>
            </section>
